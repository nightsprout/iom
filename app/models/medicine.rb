...
class Medicine < ActiveRecord::Base
  ...
  def total_regions(site)
    ...
    inner join medicines_projects as ps on ps.project_id=psi.project_id
    where ps.medicine_id=#{self.id}"
  ...
  def total_projects(site, location_id = nil)
    ...
    sql = "select count(distinct(ps.project_id)) as count from medicines_projects as ps
