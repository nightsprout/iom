...
ActiveRecord::Schema.define(:version => 20150731230553) do
  ...
  add_index "data_denormalization", ["end_date"], :name => "index_data_denormalization_on_end_date"
  ...
  add_index "data_denormalization", ["start_date"], :name => "index_data_denormalization_on_start_date"
